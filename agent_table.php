...
<head>
    ...
    <title>craft_brewery</title>
    <!-- Bootstrap CSS -->
    <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    <div class="container">
        <h2 style="text-align: center; font-family: century; font-weight: bold;">craft_brewery</h2>
...
<footer><!-- Footer section -->
            <p>&copy &reg 2024 UR CBE BIT YEAR 2iradukunda innocent @ Group c</p><!-- Copyright and trademark notice -->
